...
I use this configuration for the three-mode espClock touchscreen clock:
**Cars**, **Ants**, and **Flip Glass**.
...
private. The Flip Glass and explosion artwork is embedded in the generated
...
- Swipe left for Cars → Ants → Flip Glass → Cars; swipe right to reverse.
